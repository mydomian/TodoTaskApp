                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="{{ route('todos.show',$todo->id) }}"><i class="fas fa-eye"></i> Show</a>
                                            <a class="dropdown-item" href="{{ route('todos.edit',$todo->id) }}"><i class="fas fa-pencil-alt"></i> Edit</a>
                                            <form action="{{ route('todos.destroy', $todo->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                @csrf
                                                @method('DELETE')
...
@push('scripts')
    <script>
        $(function() {
            ...
            $('#todo-table_filter input').attr('placeholder', 'Search by title/employee');
        });
    </script>
@endpush

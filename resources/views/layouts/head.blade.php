...
<title>@stack('title') | Todo Task Management</title>
...
<link rel="stylesheet" href="{{ asset('storage/dist/css/animate.min.css') }}">
<link rel="stylesheet" href="{{ asset('storage/dist/css/toastr.css') }}">
